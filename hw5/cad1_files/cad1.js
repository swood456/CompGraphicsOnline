...
window.onload = function init() {
    ...
    document.getElementById("slider_r").onchange = function() {
        r = event.srcElement.value;

        document.getElementById("box").style.background = '#' +rgbToHex(r / 100 * 255,g / 100 * 255,b / 100 * 255);
    };

    document.getElementById("slider_g").onchange = function() {
        g = event.srcElement.value;
        document.getElementById("box").style.background = '#' +rgbToHex(r / 100 * 255,g / 100 * 255,b / 100 * 255);
    };

    document.getElementById("slider_b").onchange = function() {
